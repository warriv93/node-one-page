...
module.exports = function (page) {
  ...
  if (config.twitter.key) {
    console.log("Twitter, https://2019.theconference.se/admin/auth/twitter/callback", config.twitter.key, config.twitter.secret);
    console.log("config.host:", config.host);
    addAuthenticationService('twitter', new TwitterStrategy({
      consumerKey: config.twitter.key,
      consumerSecret: config.twitter.secret,
      callbackURL: 'https://2019.theconference.se/admin/auth/twitter/callback',
